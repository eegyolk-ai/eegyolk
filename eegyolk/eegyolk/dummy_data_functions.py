...
def generate_frequency_distribution(distribution = "planck", max_freq = 256, freq_sample_rate = 10):
    '''
     This function returns the occurence of frequencies up to 'max_freq' from a 'distribution'.
     Returns arrays of frequencies and their occurence as x and y value.
     The form of 1 / (x^2 * (exp(1/x)-1)) is inspired by Planck's law. 
...
def generate_epoch(freq_distribution, N_combined_freq = 100, max_freq = 256, duration = 2, sample_rate = 512):
    '''
