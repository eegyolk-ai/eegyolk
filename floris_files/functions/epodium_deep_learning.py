...
def clean_experiments(cleaning_method, min_standards = 180, min_deviants = 80, min_firststandards = 80):
    ...
    path_events = glob.glob(os.path.join(local_paths.epod_clean, "ePod_" + cleaning_method, "events", '*.txt'))
...
#         self.split_path = os.path.join(local_paths.epod_split, split_folder)
