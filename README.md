...
1. Install all Python packages required, using conda and the environment-march-update2.yaml file.
    run following line on your machine: `conda env create -f mne-march3_enivonrment.yml` and switch to this environment running command: `conda activate mne-march3`.
...
## Testing
At present testing requires you to have some data to test on. Configure and rename a valid bdf file as configured and named in the tests/test.py, and testing should work.